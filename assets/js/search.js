...
var documents = [{
    ...
    "body": "2020/02/29 -                        #collapseimport requestsimport pandas as pdfrom io import BytesIOimport numpy as npimport altair as alt# data downloadresponse = requests. get(&#39;https://docs. google. com/spreadsheet/ccc?key=1FwOXbkWeuS1LHrKxhSfepGtsgQ6iIEQZmWig_JKo8z0&amp;output=csv&#39;)assert response. status_code == 200, &#39;Wrong status code&#39;data = response. contentdf = pd. read_csv(BytesIO(data), parse_dates=[&#39;Fecha&#39;], dayfirst=True)# plotsource = df# Create a selection that chooses the nearest point &amp; selects based on x-valuenearest = alt. selection(type=&#39;single&#39;, nearest=True, on=&#39;mouseover&#39;,            fields=[&#39;Total confirmados&#39;], empty=&#39;none&#39;)# The basic lineline = alt. Chart(source). mark_line(interpolate=&#39;basis&#39;). encode(  x=&#39;monthdate(Fecha):O&#39;,  y=&#39;Total confirmados:Q&#39;,)# Transparent selectors across the chart. This is what tells us# the x-value of the cursorselectors = alt. Chart(source). mark_point(). encode(  x=&#39;monthdate(Fecha):O&#39;,  opacity=alt. value(0),). add_selection(  nearest)# Draw points on the line, and highlight based on selectionpoints = line. mark_point(). encode(  opacity=alt. condition(nearest, alt. value(1), alt. value(0)))# Draw text labels near the points, and highlight based on selectiontext = line. mark_text(align=&#39;left&#39;, dx=5, dy=-5). encode(  text=alt. condition(nearest, &#39;Total confirmados:Q&#39;, alt. value(&#39; &#39;)))# Draw a rule at the location of the selectionrules = alt. Chart(source). mark_rule(color=&#39;gray&#39;). encode(  x=&#39;monthdate(Fecha):O&#39;,). transform_filter(  nearest)# Put the five layers into a chart and bind the dataalt. layer(  line, selectors, points, rules, text). properties(  width=800, height=400)       "
    }, {
    "id": 5,
    "url": "https://cambrian-intelligence.github.io/2020/02/29/confirmados_datos.html",
    "title": "Confirmados - datos",
    "body": "2020/02/29 -                        #collapseimport requestsimport pandas as pdfrom io import BytesIOresponse = requests. get(&#39;https://docs. google. com/spreadsheet/ccc?key=1FwOXbkWeuS1LHrKxhSfepGtsgQ6iIEQZmWig_JKo8z0&amp;output=csv&#39;)assert response. status_code == 200, &#39;Wrong status code&#39;data = response. contentdf = pd. read_csv(BytesIO(data), index_col=0, parse_dates=[&#39;Fecha&#39;], dayfirst=True)df              Aragón   Baleares   Canarias   Cataluña   Castilla y León   Comunidad de Madrid   Comunidad Valenciana   Andalucía   Total confirmados       Fecha                                    2020-01-31   0   0   1   0   0   0   0   0   1       2020-02-01   0   0   1   0   0   0   0   0   1       2020-02-02   0   0   1   0   0   0   0   0   1       2020-02-03   0   0   1   0   0   0   0   0   1       2020-02-04   0   0   1   0   0   0   0   0   1       2020-02-05   0   0   1   0   0   0   0   0   1       2020-02-06   0   0   1   0   0   0   0   0   1       2020-02-07   0   0   1   0   0   0   0   0   1       2020-02-08   0   0   1   0   0   0   0   0   1       2020-02-09   0   1   1   0   0   0   0   0   2       2020-02-10   0   1   1   0   0   0   0   0   2       2020-02-11   0   1   1   0   0   0   0   0   2       2020-02-12   0   1   1   0   0   0   0   0   2       2020-02-13   0   1   1   0   0   0   0   0   2       2020-02-14   0   1   1   0   0   0   0   0   2       2020-02-15   0   1   1   0   0   0   0   0   2       2020-02-16   0   1   1   0   0   0   0   0   2       2020-02-17   0   1   1   0   0   0   0   0   2       2020-02-18   0   1   1   0   0   0   0   0   2       2020-02-19   0   1   1   0   0   0   0   0   2       2020-02-20   0   1   1   0   0   0   0   0   2       2020-02-21   0   1   1   0   0   0   0   0   2       2020-02-22   0   1   1   0   0   0   0   0   2       2020-02-23   0   1   1   0   0   0   0   0   2       2020-02-24   0   1   2   0   0   0   0   0   3       2020-02-25   0   1   2   0   0   0   0   0   3       2020-02-26   0   1   2   0   0   0   0   0   3       2020-02-27   0   1   6   3   0   4   2   1   17       2020-02-28   1   1   6   3   2   5   9   7   34     "
    }];
